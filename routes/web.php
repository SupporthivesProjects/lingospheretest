...
Route::get('/certified-translation', 'TranslationController@certified_translation')->name('certified_translation');
Route::get('/standard-translation', 'TranslationController@standard_translation')->name('standard_translation');
Route::get('/languages', 'HomeController@languages')->name('languages');
Route::get('/documents', 'HomeController@documents')->name('documents');
Route::get('/request-translation', 'TranslationController@request_translation')->name('request_translation');
Route::post('/cart/addToCart', 'TranslationController@addToCart')->name('service.addToCart');
Route::get('/careers', 'TranslationController@careers')->name('careers');
Route::post('/request-careers', 'TranslationController@request_careers')->name('request.careers');
