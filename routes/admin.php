...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/contactusemails', 'CurrencyController@contactusemails')->name('contactusemails.index');
	Route::get('/userlogins', 'CurrencyController@userlogins')->name('userlogins.index');
