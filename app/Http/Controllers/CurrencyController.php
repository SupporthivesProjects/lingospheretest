...
class CurrencyController extends Controller
{
    ...
    public function contactusemails(Request $request)
    {
        
        $contactusemails = ContactUs::all();
        return view('business_settings.contactusemails', compact('contactusemails'));
    ...
    public function userlogins(Request $request)
    {
        ...
        return view('business_settings.userlogins', compact('userlogins'));
